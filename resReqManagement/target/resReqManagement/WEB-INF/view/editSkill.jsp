...
<body style="text-align: center;">
	...
	<main role="main" class="container" >
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50" style="background-color: aqua; opacity:0.9;">
				<form class="login100-form validate-form" action="updateSkill?id=${skill.skillId}" method="post">
					<span class="login100-form-title p-b-33">
						Edit Technical Skill: 
					</span>

					<div class="wrap-input100 validate-input" data-validate = "name is required: xyz">
						<input class="input100" type="text" name="skillName" value="${skill.skillName}"></input>
