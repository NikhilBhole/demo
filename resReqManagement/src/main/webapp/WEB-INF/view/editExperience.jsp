...
<body style="text-align: center;">
	...
	<main role="main" class="container" >
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50" style="background-color: aqua; opacity:0.9;">
				<form class="login100-form validate-form" action="updateExperience?id=${experience.workExpId}" method="post">
					<span class="login100-form-title p-b-33">
						Edit Work Experience: 
					</span>

					<div class="wrap-input100 validate-input" data-validate = "name is required: xyz">
						<input class="input100" type="text" name="preCompanyName" value="${experience.preCompanyName}"></input>
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
					
					<div class="wrap-input100 validate-input" data-validate = "name is required: xyz">
						<input class="input100" type="text" name="startDate" value="${experience.startDate}"></input>
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
					
					<div class="wrap-input100 validate-input" data-validate = "name is required: xyz">
						<input class="input100" type="text" name="endDate" value="${experience.endDate}"></input>
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>

					<div class="wrap-input100 rs1 validate-input" data-validate="username is required">
						<input class="input100" type="text" name="designation" value="${experience.designation}"></input>
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
